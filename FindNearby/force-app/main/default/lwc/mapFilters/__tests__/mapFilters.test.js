...
describe('c-map-filters', () => {
    beforeEach(() => {
        ...
        element.currentFieldFilter = { isActive: true, field: { value: '', label: '', type: '', input: '' } };
        ...
        objectFilterButton = element.shadowRoot.querySelectorAll('.filter-button')[0];
        objectSheet = element.shadowRoot.querySelector('.object-filter-bottom-sheet');
        objectRadio = element.shadowRoot.querySelector('.object-filter-bottom-sheet lightning-radio-group');
        xButtonObj = element.shadowRoot.querySelector('.object-filter-bottom-sheet .x');

        fieldFilterButton = element.shadowRoot.querySelectorAll('.filter-button')[1];
        fieldFilterSheet = element.shadowRoot.querySelector('.field-filter-bottom-sheet');
        xButtonFieldFilter = element.shadowRoot.querySelector('.field-filter-bottom-sheet .x');
        showResultsButton = element.shadowRoot.querySelector('.filters-sheet-show-results');

        fieldsListSheet = element.shadowRoot.querySelector('.fields-list-bottom-sheet');
        fieldListRadio = element.shadowRoot.querySelector('.fields-list-bottom-sheet lightning-radio-group');
        xButtonFieldsList = element.shadowRoot.querySelector('.fields-list-bottom-sheet .x');
    })
    ...
    it('has object filter filled', async () => {
        return Promise.resolve().then(() => {
            const currentObject = objectFilterButton.querySelector('.button-text-main');
    ...
    it('calls setCurrentObjectFilter when changing object filter', async () => {
        ...
        return Promise.resolve().then(async () => {
            ...
            return Promise.resolve().then(() => {
                expect(element.setCurrentObjectFilter).toHaveBeenCalledWith(element.mapObjects[1]);
            });
        });
    });
    ...
    describe('c-map-filters field filter', () => {
        describe('basic field filter', () => {
            beforeEach(async () => {
                ...
                return Promise.resolve().then(async () => {
                    inputField = element.shadowRoot.querySelector('.field-input-container lightning-input');
                });
            })
            ...
            it('changes field filter button to active when show results clicked', async () => {
                ...
                return Promise.resolve().then(async () => {
                    ...
                    return Promise.resolve().then(() => {
                        const fieldFilterButton = element.shadowRoot.querySelectorAll('.filter-button')[1];
