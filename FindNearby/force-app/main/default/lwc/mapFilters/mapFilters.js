...
export default class MapFilters extends LightningElement {
    ...
    get filterFieldButtonClass() {
        ...
        return `${buttonClasses} ${this.currentFieldFilter.isActive ? 'active-button' : 'inactive-button'}`;
    }
    ...
    get fieldRadioOptions() {
        ...
        const objFields = this.mapObjects.find(o => o.value === this.currentObjectFilter.value).fields;
        return objFields
    ...
    get showResultsDisabled() {
        return !this.selectedFieldFilter.value ||
    ...
    onFieldRadioChange = (e) => {
        try {
            e.preventDefault();
            e.stopPropagation();
            this.selectedFieldFilter = { ...this.fieldRadioOptions.find(o => o.value === e.target.value) };
    ...
    clearFieldFilter() {
        this.setCurrentFieldFilter(false, { label: '',  value: '', type: '', input: '' });
    }
