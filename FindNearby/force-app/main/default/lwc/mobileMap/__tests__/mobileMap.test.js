...
describe('c-mobile-map', () => {
    beforeEach(() => {
        ...
        element.filteredMarkers = [
            { location: { Latitude: 10, Longitude: 10 }, value: { title: 'marker title1' } },
            { location: { Latitude: 20, Longitude: 20 }, value: { title: 'marker title2' } },
            { location: { Latitude: 30, Longitude: 30 }, value: { title: 'marker title3' } }
        ];
