...
describe("c-edit-card-modal", () => {
  ...
  it("does not clear main conditions when changing condition logic", async () => {
    ...
    const conditionCombobox = element.shadowRoot.querySelector(
      ".condition-combobox"
    );
  ...
  it("removes condition when delete clicked", async () => {
    ...
    const deleteButton = element.shadowRoot.querySelector(
      ".condition lightning-button-icon"
    );
    deleteButton.click();
    return Promise.resolve().then(() => {
      conditions = element.shadowRoot.querySelectorAll(".condition");
  ...
  it("reorders sub filters on drag", async () => {
    const firstSubFilter =
      element.shadowRoot.querySelectorAll("c-sub-filter-card")[0];
    const secondSubFilter =
      element.shadowRoot.querySelectorAll("c-sub-filter-card")[1];
