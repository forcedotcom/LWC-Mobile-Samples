...
export default class MobileAppointmentBookingResourceAssignment extends LightningElement {
  ...
  @api excludedMsg =
    this.LABELS.FollowUpAppointments_cant_select_Mobile_Worker_excluded;
  resourceAssignmentTitle =
    this.LABELS.FollowUpAppointments_Mobile_Worker_radio_title;
  ...
  get options() {
    return [
      {
        label: `${
          this.LABELS.FollowUpAppointments_Mobile_Worker_radio_assignToMe_lable
        } (${this.userName || " "})`,
        value: "ASSIGN_TO_ME"
      },
      {
