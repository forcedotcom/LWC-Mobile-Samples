...
describe('c-dashboard-settings-card', () => {
  ...
  it('should have correct criteria text', () => {
    const filterSection = element.shadowRoot.querySelectorAll('.details-section')[1];
  ...
  it('should call moveCardUp when edit clicked', async () => {
    const actionGroup = element.shadowRoot.querySelectorAll('lightning-button-group')[0];
  ...
  it('should call handleEditCardClick when edit clicked', async () => {
    const actionGroup = element.shadowRoot.querySelectorAll('lightning-button-group')[1];
  ...
  it('should call duplicateCard when duplicate clicked', async () => {
    const action = element.shadowRoot.querySelectorAll('lightning-menu-item')[0];
    action.click();
    return Promise.resolve().then(() => {
  ...
  it('should call deleteCard when delete clicked', async () => {
    const action = element.shadowRoot.querySelectorAll('lightning-menu-item')[1];
    action.click();
    return Promise.resolve().then(() => {
