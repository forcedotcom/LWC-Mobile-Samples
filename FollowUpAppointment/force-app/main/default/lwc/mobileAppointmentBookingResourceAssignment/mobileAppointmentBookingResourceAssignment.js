...
export default class MobileAppointmentBookingResourceAssignment extends LightningElement {
  ...
  get options() {
    return [
      {
        label: `${this.LABELS.FollowUpAppointments_Mobile_Worker_radio_assignToMe_lable} (${
          this.userName || ' '
        })`,
        value: 'ASSIGN_TO_ME',
      },
      {
        label: this.LABELS.FollowUpAppointments_Mobile_Worker_radio_assignToAnyAvailable_lable,
