...
export default class MobileAppointmentBookingSlotsContainer extends LightningElement {
  ...
  MONTHNAME = [
    this.LABELS.FollowUpAppointments_MonthName_January,
  ...
  DAYNAME = [
    this.LABELS.FollowUpAppointments_WeekDayLong_Sunday,
  ...
  formatTitle(value) {
    ...
    var title =
      this.DAYNAME[date.getDay()] + ',  ' + this.MONTHNAME[date.getMonth()] + ' ' + date.getDate();
  ...
  getFirstDayOfWeek(date, index) {
    ...
    let newDate = new Date(d.setDate(d.getDate() - this.showNoOfDaysBeforeAfterWeek)).setHours(
      0,
      0,
      0,
      0
