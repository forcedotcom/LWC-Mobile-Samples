...
export default class MobileWorkFlowPreviewScreen extends LightningElement {
    ...
    @api screenTitle = this.LABELS.FollowUpAppointments_preview_appointmentDateTime_title;
    @api screenSubTitle = "Step 1 of 4";
    fieldListArray = [];
    @api footerTitle = this.LABELS.FollowUpAppointments_preview_step_not_editable;
    @api appointmentDetailTitle = this.LABELS.FollowUpAppointments_preview_appointmentDetails_title;
    @api mobileWorkerText = this.LABELS.FollowUpAppointments_preview_mobileWorker_title;
