...
export default class ImageCropper extends LightningElement {
    ...
    initialRender() {
        ...
        this.imageContainer = this.template.querySelector('[data-id="imageContainer"]');
        ...
        contentArea.style.maxHeight = (this.contentHeight - footerArea.clientHeight) + "px";
        contentArea.style.height = contentArea.style.maxHeight;

        this.imageContainer.style.maxHeight = (this.contentHeight - footerArea.clientHeight - (2 * contentPaddingPx)) + "px";
    ...
    createNewCropperWith(imageData) {
        ...
        this.imageContainer.replaceChild(this.imageToCrop, this.imageContainer.childNodes[0]);
