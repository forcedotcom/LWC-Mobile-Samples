...
describe('c-image-annotate', () => {
    ...
    it('displays just the image when enters the screen', () => {
        ...
        const imageCropper = imageAnnotate.shadowRoot.querySelector('c-image-cropper');
        expect(imageCropper).toBeNull();
        const imagePainter = imageAnnotate.shadowRoot.querySelector('c-image-painter');
    ...
    it('displays imageCropper when crop is clicked', async () => {
        ...
        // Act
        document.body.appendChild(imageAnnotate);
        const cropButton = imageAnnotate.shadowRoot.querySelector('button[title="Crop"]');
        cropButton.click();
    ...
    it('displays imagePainter when draw is clicked', async () => {
        ...
        // Act
        document.body.appendChild(imageAnnotate);
        const drawButton = imageAnnotate.shadowRoot.querySelector('button[title="Draw"]');
        drawButton.click();
        await Promise.resolve();
    ...
    it('displays imagePainter when add square is clicked', async () => {
        ...
        // Act
        document.body.appendChild(imageAnnotate);
        const showMoreButton = imageAnnotate.shadowRoot.querySelector('button[title="More Actions"]');
        showMoreButton.click();
        await Promise.resolve();
        const addSquareButton = imageAnnotate.shadowRoot.querySelector('span[title="Add Square"]');
    ...
    it('displays imagePainter when add circle is clicked', async () => {
        ...
        showMoreButton.click();
        await Promise.resolve();
        const addCircleButton = imageAnnotate.shadowRoot.querySelector('span[title="Add Circle"]');
    ...
    it('displays imagePainter when add line is clicked', async () => {
        ...
        showMoreButton.click();
        await Promise.resolve();
        const addLineButton = imageAnnotate.shadowRoot.querySelector('span[title="Add Line"]');
        addLineButton.click();
        await Promise.resolve();
    ...
    it('dispatches an event when remove is clicked', async () => {
        ...
        showMoreButton.click();
        await Promise.resolve();
        const removeButton = imageAnnotate.shadowRoot.querySelector('span[title="Remove"]');
        removeButton.click();
        await Promise.resolve();
