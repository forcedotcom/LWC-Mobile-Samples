...
export default class MobileAppointmentBookingLanding extends LightningElement {
    ...
    calculateMaxValidHorizonDate() {
        if(this.schedulingHorizonValue && this.selectedHorizonUnit) {
            ...
            var targetDate;
            let schedulingHorizonValueToNumber = parseInt(this.schedulingHorizonValue);
            switch(this.selectedHorizonUnit) {
                case this.SCHEDULING_UNIT_WEEK:
                    targetDate = new Date(currentDate.setDate(currentDate.getDate() + schedulingHorizonValueToNumber*7));
                break;
                case this.SCHEDULING_UNIT_MONTH:
                    targetDate = new Date(currentDate.setMonth(currentDate.getMonth() + schedulingHorizonValueToNumber));
                break;
                default: //this.SCHEDULING_UNIT_DAY
                    targetDate = new Date(currentDate.setDate(currentDate.getDate() + schedulingHorizonValueToNumber));
            }
                ...
                .then((saData) => {
                    if(saData.dummyServiceAppointmentId) {
                        ...
                        this.sleep(3000).then(() => {
                            ...
                            getSlotsByAssignmentMethod({ serviceAppointmentId: saData.dummyServiceAppointmentId,
                            ...
                            .then((data) => {
                                ...
                                if(data.error) {
                                    ...
                                    var tempDate = loopdate.setDate(loopdate.getDate() + this.maxDaysToGetAppointmentSlots);
            ...
            if(selectedSlotStart.getTime() !== this.convertDateUTCtoLocal(ArrivalWindowStartTime).getTime()) {
                ...
                .then((data) => {
                    if(data.error) {
                        ...
                        this.handleShowToast("warning", this.LABELS.Appointment_ReBooking_toastMessage_reschedule_appointment_fail_message, "");
                        ...
                        .then((data) => {
                            ...
                            if(data.error) {
                                this.showSpinnerInChildClass = false;
                                this.handleShowToast("warning", this.LABELS.Appointment_ReBooking_toastMessage_reschedule_appointment_fail_message, "");
                                console.log("Error while executing FSL API : " +"  "+ JSON.stringify(data.error));
                            } else {
                                ...
                                this.handleShowToast("success", this.LABELS.Appointment_ReBooking_toastMessage_appointment_reschedule, this.selectedSlotStringForToast);
                                this.isAppointmentConfirmed = true;   
                ...
                this.allowScrolling();
                this.showSpinnerInChildClass = false;
                this.handleShowToast("warning", this.LABELS.Appointment_ReBooking_same_appointment_selected_warning, "");
            }
    ...
    getIdFromName(){      
        if(this.schedulingPolicy){
           ...
           console.log("schedulingPolicy is undefined, getSchedulingPolicyId not called") 
        }
        ...
        if(this.operatingHours){
            ...
            console.log("operatingHours is undefined, getOperatingHoursId not called") 
        }
    }
